...
namespace Core.Persistance.Repositories
{
        ...
        where TContext : DbContext
    {
        ...
        {
            entity.ModifiedDate = DateTime.UtcNow.AddHours(3);
        ...
        protected async Task SetEntityAsDeletedAsync(TEntity entity, bool permanent)
        {
            if (!permanent)
            {
                CheckHasEntityHaveOnToOneRelation(entity);
        ...
        private void CheckHasEntityHaveOnToOneRelation(TEntity entity)
        {
            bool hasEntityHaveOnToOneRelation =
                Context
                .Entry(entity)
            ...
            if (hasEntityHaveOnToOneRelation)
                throw new InvalidOperationException(
                    "Entity has one-to-one relationship. Sof delete causes problems if you try yo create entry again by same foreign key."
                    );
        }
